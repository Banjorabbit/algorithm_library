...
namespace InterfaceTests // this namespace contains interface tests and should be used in any unit test of an algorithm
{
    ...
    bool resetTest()
    {
        ...
        else { fmt::print("resetTest failed.\nSize before reset: {0} \nSize after reset: {1} \n", size, sizeOut); return false; }
    }
    ...
    bool getSetTest()
    {
        ...
        auto sizeOut = algo.getDynamicSize();
        if (size != sizeOut) { fmt::print("getSetTest failed. Parameter test failed.\n"); return false; }
        ...
        if (sizeOut != sizeOut2) { fmt::print("getSetTest failed. Coefficient test failed since dynamic memory changed after setting coefficients. Before: {}. After: {}\n", sizeOut, sizeOut2); return false; }
        if (size != sizeOut2) { fmt::print("getSetTest failed. Coefficient test failed.\n"); return false; }
        ...
        if (sizeOut != sizeOut2) { fmt::print("getSetTest failed. Setup test failed since dynamic memory changed after setting setup. Before: {}. After: {}\n", sizeOut, sizeOut2); return false; }
        if (size != sizeOut2) { fmt::print("getSetTest failed. Setup test failed.\n"); return false; }
