...
struct SplineConfiguration
{
    ...
    static Eigen::ArrayXXf initOutput(Input input, const Coefficients& c) { return Eigen::ArrayXXf::Zero(input.xDesired.rows(), input.xDesired.cols()); } // size of desired y values is determined by xDesired
